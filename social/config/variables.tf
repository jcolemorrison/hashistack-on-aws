variable "project_name" {
  ...
  default     = "hashistack-social-config"
}
...
variable "aws_default_tags" {
  ...
  default = {
    Project = "hashistack-social-config"
  }
}
...
variable "vpc_id" {
  type        = string
  description = "The ID of the social infrastructure VPC."
  default     = null
}

variable "vpc_public_subnet_ids" {
  type        = list(string)
  description = "List of public subnet IDs for the social infrastructure VPC."
  default     = null
}
...
variable "hcp_tf_social_infra_workspace_name" {
  type        = string
  description = "The name of the hashistack social aws infrastructure workspace."
}