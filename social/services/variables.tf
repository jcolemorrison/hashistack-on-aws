variable "project_name" {
  ...
  default     = "hashistack-social-services"
}
...
variable "aws_default_tags" {
  ...
  default = {
    Project = "hashistack-social-services"
  }
}
...
variable "hcp_tf_social_config_workspace_name" {
  type        = string
  description = "The name of the hashistack social aws config workspace."
}