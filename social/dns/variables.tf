...
variable "hcp_tf_social_services_workspace_name" {
  type        = string
  description = "The name of the hashistack social aws services workspace."
}